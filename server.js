...
// --- 1. CORS Fix (በምስሉ ላይ የታየውን ቀይ ስህተት ለመፍታት) ---
app.use(cors({
    origin: [ "https://ethio-aviator-front-vercel.app"],
    methods: ["GET", "POST"],
    credentials: true
}));
...
const TELEGRAM_TOKEN = '8449298842:AAGGfoTIni6JPZDubsHE-AlcE593b_I82I4';
const ADMIN_CHAT_ID = '2068983666';
const bot = new TelegramBot(TELEGRAM_TOKEN, { polling: true });

bot.on('polling_error', (error) => {
    if (!error.message.includes('409')) console.log("Bot Update:", error.message);
});
